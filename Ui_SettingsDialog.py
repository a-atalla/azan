...
#
# Created: Sat Nov 20 23:47:07 2010
...
"")
        ...
        self.spinHideZekrTimer = QtGui.QSpinBox(self.tabWidgetPage2)
        self.spinHideZekrTimer.setObjectName("spinHideZekrTimer")
        self.horizontalLayout_15.addWidget(self.spinHideZekrTimer)
        ...
        self.groupBox_3 = QtGui.QGroupBox(self.tabWidgetPage2)
        self.groupBox_3.setObjectName("groupBox_3")
        self.gridLayout = QtGui.QGridLayout(self.groupBox_3)
        self.gridLayout.setObjectName("gridLayout")
        self.rbBottomLeft = QtGui.QRadioButton(self.groupBox_3)
        self.rbBottomLeft.setText("")
        self.rbBottomLeft.setObjectName("rbBottomLeft")
        self.gridLayout.addWidget(self.rbBottomLeft, 2, 0, 1, 1)
        self.rbTopLeft = QtGui.QRadioButton(self.groupBox_3)
        self.rbTopLeft.setText("")
        self.rbTopLeft.setObjectName("rbTopLeft")
        self.gridLayout.addWidget(self.rbTopLeft, 0, 0, 1, 1)
        self.rbTopRight = QtGui.QRadioButton(self.groupBox_3)
        self.rbTopRight.setText("")
        self.rbTopRight.setObjectName("rbTopRight")
        self.gridLayout.addWidget(self.rbTopRight, 0, 2, 1, 1)
        self.rbBottomRight = QtGui.QRadioButton(self.groupBox_3)
        self.rbBottomRight.setText("")
        self.rbBottomRight.setChecked(True)
        self.rbBottomRight.setObjectName("rbBottomRight")
        self.gridLayout.addWidget(self.rbBottomRight, 2, 2, 1, 1)
    ...
    def retranslateUi(self, SettingsDialog):
        ...
        self.label_9.setText(QtGui.QApplication.translate("SettingsDialog", "ثانية", None, QtGui.QApplication.UnicodeUTF8))
        self.label_10.setText(QtGui.QApplication.translate("SettingsDialog", "أغلاق  الأذكار بعد ", None, QtGui.QApplication.UnicodeUTF8))
        self.groupBox_3.setTitle(QtGui.QApplication.translate("SettingsDialog", "مكان ظهور الأذكار", None, QtGui.QApplication.UnicodeUTF8))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabWidgetPage2), QtGui.QApplication.translate("SettingsDialog", "إعدادات التذكير", None, QtGui.QApplication.UnicodeUTF8))
